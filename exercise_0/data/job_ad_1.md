...
The Data Platform team at Instabee is looking for a Data Engineer with an interest in Analytics Engineering to help build and maintain a modern data platform on GCP and Snowflake using tools like FiveTran, Python, DBT, Airflow and Tableau. You will design and implement data integration patterns, set up CI/CD and infrastructure as code, model data with DBT and SQL, and collaborate with business stakeholders to create trustworthy data products that support BI, data science and product teams. Ideal candidates have a technical degree, experience in both data and analytics engineering, skills in Python/SQL/DBT, familiarity with Docker/Kubernetes or streaming data is a plus, and are based in Stockholm and open to hybrid work. Instabee offers a modern office with city views, dog‑friendly policies, tech breakfasts, flexible hours, parental leave and a day off for your birthday, all within a fast‑growing e‑commerce logistics company committed to diversity and inclusion.